    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("role", models.CharField(choices=[("customer", "Customer"), ("rider", "Rider")], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("user", models.OneToOneField(on_delete=models.deletion.CASCADE, related_name="rider_profile", to="accounts.user")),
            ],
        ),
    ]
